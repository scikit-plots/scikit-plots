# scikitplot/utils/tests/test__testing.py
#
# fmt: off
# ruff: noqa
# ruff: noqa: PGH004
...
# mypy: ignore-errors
# type: ignore
# codespell:ignore datas  # cannot ignore an entire file.
#
# This module was copied from the scikit-learn project.
# https://github.com/scikit-learn/scikit-learn/blob/main/sklearn/utils/tests/test_testing.py
#
