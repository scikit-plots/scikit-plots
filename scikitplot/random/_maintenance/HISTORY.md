...
Exposes the KISS RNG with a NumPy-compatible surface. Three markdown files record the design; none records whether a seeded stream is stable across releases.
