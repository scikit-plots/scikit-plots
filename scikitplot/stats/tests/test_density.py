...
from scikitplot._compat import groupby_apply_include_groups
from scikitplot._core.groupby import GroupBy
...
class TestKDE:
    ...
    def test_gridsize(self, df, gridsize):
        ...
        if gridsize is None:
            npt.assert_array_equal(res[ori], df[ori])
        else:
    ...
    def test_common_norm(self, df, common_norm):
        ...
        if common_norm:
            ...
            npt.assert_array_almost_equal(areas, [1, 1], decimal=3)
    ...
    def test_common_norm_variables(self, df):
        ...
        print('areas', areas)
        # npt.assert_array_almost_equal(areas, [1, 1], decimal=3)
        npt.assert_allclose(areas, [1, 1], rtol=1e-2)
