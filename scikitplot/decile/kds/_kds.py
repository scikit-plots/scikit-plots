...
def decile_table(
    ...
    **kwargs : dict, optional
    ...
    if feature_infos is True:
        # print decile table feature infos
        print_labels()
    return dt


@_preprocess._preprocess_data(
    replace_names=["y_true", "y_score"]
...
def plot_lift(
    ...
    **kwargs : dict, optional
    ...
    pl = decile_table(y_true, y_score)
...
def plot_lift_decile_wise(
    ...
    **kwargs : dict, optional
    ...
    pldw = decile_table(y_true, y_score)
...
def plot_cumulative_gain(
    ...
    **kwargs : dict, optional
    ...
    pcg = decile_table(y_true, y_score)
...
def plot_ks_statistic(
    ...
    **kwargs : dict, optional
    ...
    pks = decile_table(y_true, y_score)
...
def report(
    ...
    **kwargs,
    ...
    feature_infos : bool, optional, default=True
        If True, prints a legend for the abbreviations of decile table column names.
