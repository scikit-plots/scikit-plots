...
from ..utils import _utils as utils
...
class FacetGrid(Grid):
    ...
    def map(self, func, *args, **kwargs):
        ...
        if func_module == f'{_module}.api.categorical':  # "seaborn.categorical":
        ...
        for (row_i, col_j, hue_k), data_ijk in self.facet_data():
            ...
            modify_state = not func_module.startswith(f'{_module}')
    ...
    def map_dataframe(self, func, *args, **kwargs):
        ...
        for (row_i, col_j, hue_k), data_ijk in self.facet_data():
            ...
            # Get the current axis
            modify_state = not str(func.__module__).startswith(f'{_module}')
            ax = self.facet_axis(row_i, col_j, modify_state)
    ...
    def _facet_plot(self, func, ax, plot_args, plot_kwargs):
        ...
        # Draw the plot
        if str(func.__module__).startswith(f'{_module}'):
...
class JointGrid(_BaseGrid):
    ...
    def plot_marginals(self, func, **kwargs):
        ...
        """
        seaborn_func = (
            str(func.__module__).startswith(f'{_module}')
