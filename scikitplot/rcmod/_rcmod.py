"""This module was copied from the seaborn project.
...
from ..palettes import _palettes as palettes
...
def reset_defaults():
    ...
    .. dropdown:: View aliases
        ...
        **Main aliases**
        ...
        `scikitplot.rcmod.reset_defaults`

        **Compat aliases**
        
        `scikitplot.reset_defaults`
    """
...
def reset_orig():
    ...
    .. dropdown:: View aliases
        ...
        **Main aliases**
        ...
        `scikitplot.rcmod.reset_orig`

        **Compat aliases**
        
        `scikitplot.reset_orig`
    """
