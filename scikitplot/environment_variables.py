...
- Internal-use variables: For variables used only internally, names start with `_SKPLT_`
...
class _EnvironmentVariable:
    ...
    def get(self):
        ...
        if it exists and converts it to the desired type.
...
#: (default: ``None``)
SKPLT_TRACKING_URI = _EnvironmentVariable("SKPLT_TRACKING_URI", str, None)

#: Specifies the registry URI.
#: (default: ``None``)
SKPLT_REGISTRY_URI = _EnvironmentVariable("SKPLT_REGISTRY_URI", str, None)
...
#: (default: ``7``)
SKPLT_HTTP_REQUEST_MAX_RETRIES = _EnvironmentVariable(
...
#: (default: ``True``)
SKPLT_HTTP_RESPECT_RETRY_AFTER_HEADER = _BooleanEnvironmentVariable(
...
#: (default: ``10``)
_SKPLT_HTTP_REQUEST_MAX_RETRIES_LIMIT = _EnvironmentVariable(
...
#: (default: ``120``)
_SKPLT_HTTP_REQUEST_MAX_BACKOFF_FACTOR_LIMIT = _EnvironmentVariable(
...
SKPLT_TRACKING_AWS_SIGV4 = _BooleanEnvironmentVariable(
    "SKPLT_TRACKING_AWS_SIGV4", False
)
...
SKPLT_TRACKING_AUTH = _EnvironmentVariable("SKPLT_TRACKING_AUTH", str, None)
...
SKPLT_GCS_DOWNLOAD_CHUNK_SIZE = _EnvironmentVariable(
...
#: for more information.
#: (default: ``None``)
SKPLT_SQLALCHEMYSTORE_POOL_SIZE = _EnvironmentVariable(
...
#: for more information.
#: (default: ``None``)
SKPLT_SQLALCHEMYSTORE_POOL_RECYCLE = _EnvironmentVariable(
...
#: for more information.
#: (default: ``None``)
SKPLT_SQLALCHEMYSTORE_MAX_OVERFLOW = _EnvironmentVariable(
...
#: for more information.
#: (default: ``False``)
SKPLT_SQLALCHEMYSTORE_ECHO = _BooleanEnvironmentVariable(
    "SKPLT_SQLALCHEMYSTORE_ECHO", False
)

#: Specifies whether or not to print a warning when `--env-manager=conda` is specified.
#: (default: ``False``)
SKPLT_DISABLE_ENV_MANAGER_CONDA_WARNING = _BooleanEnvironmentVariable(
...
SKPLT_ARTIFACT_UPLOAD_DOWNLOAD_TIMEOUT = _EnvironmentVariable(
...
SKPLT_INPUT_EXAMPLE_INFERENCE_TIMEOUT = _EnvironmentVariable(
...
SKPLT_DEFAULT_PREDICTION_DEVICE = _EnvironmentVariable(
...
SKPLT_HUGGINGFACE_DISABLE_ACCELERATE_FEATURES = _BooleanEnvironmentVariable(
    "SKPLT_DISABLE_HUGGINGFACE_ACCELERATE_FEATURES", False
)

#: Specifies to Huggingface whether to use the automatic device placement logic of
# HuggingFace accelerate. If it's set to false, the low_cpu_mem_usage flag will not be
# set to True and device_map will not be set to "auto". Default to False.
SKPLT_HUGGINGFACE_USE_DEVICE_MAP = _BooleanEnvironmentVariable(
...
SKPLT_HUGGINGFACE_DEVICE_MAP_STRATEGY = _EnvironmentVariable(
...
SKPLT_HUGGINGFACE_USE_LOW_CPU_MEM_USAGE = _BooleanEnvironmentVariable(
...
SKPLT_HUGGINGFACE_MODEL_MAX_SHARD_SIZE = _EnvironmentVariable(
...
SKPLT_OPENAI_SECRET_SCOPE = _EnvironmentVariable("SKPLT_OPENAI_SECRET_SCOPE", str, None)
...
SKPLT_WHEELED_MODEL_PIP_DOWNLOAD_OPTIONS = _EnvironmentVariable(
...
#: see https://requests.readthedocs.io/en/master/api/
#: (default: ``None``)
SKPLT_TRACKING_SERVER_CERT_PATH = _EnvironmentVariable(
...
#: see https://requests.readthedocs.io/en/master/api/
#: (default: ``None``)
SKPLT_TRACKING_CLIENT_CERT_PATH = _EnvironmentVariable(
    "SKPLT_TRACKING_CLIENT_CERT_PATH", str, None
)

#: Specified the ID of the run to log data to.
#: (default: ``None``)
SKPLT_RUN_ID = _EnvironmentVariable("SKPLT_RUN_ID", str, None)

#: Specifies the default root directory for tracking `FileStore`.
#: (default: ``None``)
SKPLT_TRACKING_DIR = _EnvironmentVariable("SKPLT_TRACKING_DIR", str, None)

#: Specifies the default root directory for registry `FileStore`.
#: (default: ``None``)
SKPLT_REGISTRY_DIR = _EnvironmentVariable("SKPLT_REGISTRY_DIR", str, None)

#: Specifies the default experiment ID to create run to.
#: (default: ``None``)
SKPLT_EXPERIMENT_ID = _EnvironmentVariable("SKPLT_EXPERIMENT_ID", str, None)

#: Specifies the default experiment name to create run to.
#: (default: ``None``)
SKPLT_EXPERIMENT_NAME = _EnvironmentVariable("SKPLT_EXPERIMENT_NAME", str, None)

#: Specified the path to the configuration file for MLflow Authentication.
#: (default: ``None``)
SKPLT_AUTH_CONFIG_PATH = _EnvironmentVariable("SKPLT_AUTH_CONFIG_PATH", str, None)

#: Specifies and takes precedence for setting the UC OSS basic/bearer auth on http requests.
#: (default: ``None``)
SKPLT_UC_OSS_TOKEN = _EnvironmentVariable("SKPLT_UC_OSS_TOKEN", str, None)
...
#: (default: ``False``)
SKPLT_ENABLE_DBFS_FUSE_ARTIFACT_REPO = _BooleanEnvironmentVariable(
...
#: (default: ``True``)
SKPLT_ENABLE_UC_VOLUME_FUSE_ARTIFACT_REPO = _BooleanEnvironmentVariable(
...
#: (default: ``False``)
_SKPLT_AUTOLOGGING_TESTING = _BooleanEnvironmentVariable(
    "SKPLT_AUTOLOGGING_TESTING", False
)

#: (Experimental, may be changed or removed)
#: Specifies the uri of a MLflow Gateway Server instance to be used with the Gateway Client APIs
#: (default: ``None``)
SKPLT_GATEWAY_URI = _EnvironmentVariable("SKPLT_GATEWAY_URI", str, None)

#: (Experimental, may be changed or removed)
#: Specifies the uri of an MLflow AI Gateway instance to be used with the Deployments
#: Client APIs
#: (default: ``None``)
SKPLT_DEPLOYMENTS_TARGET = _EnvironmentVariable("SKPLT_DEPLOYMENTS_TARGET", str, None)

#: Specifies the path of the config file for MLflow AI Gateway.
#: (default: ``None``)
SKPLT_GATEWAY_CONFIG = _EnvironmentVariable("SKPLT_GATEWAY_CONFIG", str, None)

#: Specifies the path of the config file for MLflow AI Gateway.
#: (default: ``None``)
SKPLT_DEPLOYMENTS_CONFIG = _EnvironmentVariable("SKPLT_DEPLOYMENTS_CONFIG", str, None)

#: Specifies whether to display the progress bar when uploading/downloading artifacts.
#: (default: ``True``)
SKPLT_ENABLE_ARTIFACTS_PROGRESS_BAR = _BooleanEnvironmentVariable(
    "SKPLT_ENABLE_ARTIFACTS_PROGRESS_BAR", True
)

#: Specifies the conda home directory to use.
#: (default: ``conda``)
SKPLT_CONDA_HOME = _EnvironmentVariable("SKPLT_CONDA_HOME", str, None)
...
#: training) setup.
SKPLT_SYSTEM_METRICS_NODE_ID = _EnvironmentVariable(
...
# download.
_SKPLT_MPD_NUM_RETRIES = _EnvironmentVariable("_SKPLT_MPD_NUM_RETRIES", int, 3)

# Private environment variable to specify the interval between chunk download retries for multipart
# download.
_SKPLT_MPD_RETRY_INTERVAL_SECONDS = _EnvironmentVariable(
...
SKPLT_MULTIPART_UPLOAD_MINIMUM_FILE_SIZE = _EnvironmentVariable(
...
#: (default: ``524_288_000`` (500 MB))
SKPLT_MULTIPART_DOWNLOAD_MINIMUM_FILE_SIZE = _EnvironmentVariable(
...
SKPLT_MULTIPART_UPLOAD_CHUNK_SIZE = _EnvironmentVariable(
...
SKPLT_MULTIPART_DOWNLOAD_CHUNK_SIZE = _EnvironmentVariable(
...
#: (default: ``True``)
SKPLT_ALLOW_HTTP_REDIRECTS = _BooleanEnvironmentVariable(
...
#: (default: ``120``)
SKPLT_DEPLOYMENT_PREDICT_TIMEOUT = _EnvironmentVariable(
    "SKPLT_DEPLOYMENT_PREDICT_TIMEOUT", int, 120
)

SKPLT_GATEWAY_RATE_LIMITS_STORAGE_URI = _EnvironmentVariable(
...
#: (default: ``True``)
SKPLT_CONFIGURE_LOGGING = _BooleanEnvironmentVariable(
    "SKPLT_LOGGING_CONFIGURE_LOGGING", True
)
...
#: length.
#: (default: ``True``)
SKPLT_TRUNCATE_LONG_VALUES = _BooleanEnvironmentVariable(
...
_SKPLT_RUN_SLOW_TESTS = _BooleanEnvironmentVariable("SKPLT_RUN_SLOW_TESTS", False)

#: The OpenJDK version to install in the Docker image used for MLflow models.
#: (default: ``11``)
SKPLT_DOCKER_OPENJDK_VERSION = _EnvironmentVariable(
...
SKPLT_TRACE_TIMEOUT_SECONDS = _EnvironmentVariable(
...
#: positive value.
SKPLT_TRACE_TIMEOUT_CHECK_INTERVAL_SECONDS = _EnvironmentVariable(
...
#: (default: ``False``)
_SKPLT_EVALUATE_SUPPRESS_CLASSIFICATION_ERRORS = _BooleanEnvironmentVariable(
...
SKPLT_REQUIREMENTS_INFERENCE_RAISE_ERRORS = _BooleanEnvironmentVariable(
    "SKPLT_REQUIREMENTS_INFERENCE_RAISE_ERRORS", False
)

# How many traces to display in Databricks Notebooks
SKPLT_MAX_TRACES_TO_DISPLAY_IN_NOTEBOOK = _EnvironmentVariable(
...
_SKPLT_ENABLE_TRACE_DUAL_WRITE_IN_MODEL_SERVING = _EnvironmentVariable(
    "SKPLT_ENABLE_TRACE_DUAL_WRITE_IN_MODEL_SERVING", bool, False
)

# Default addressing style to use for boto client
SKPLT_BOTO_CLIENT_ADDRESSING_STYLE = _EnvironmentVariable(
    "SKPLT_BOTO_CLIENT_ADDRESSING_STYLE", str, "auto"
)

#: Specify the timeout in seconds for Databricks endpoint HTTP request retries.
SKPLT_DATABRICKS_ENDPOINT_HTTP_RETRY_TIMEOUT = _EnvironmentVariable(
...
SKPLT_HTTP_POOL_CONNECTIONS = _EnvironmentVariable(
...
SKPLT_HTTP_POOL_MAXSIZE = _EnvironmentVariable("SKPLT_HTTP_POOL_MAXSIZE", int, 10)

#: Enable Unity Catalog integration for MLflow AI Gateway.
#: (default: ``False``)
SKPLT_ENABLE_UC_FUNCTIONS = _BooleanEnvironmentVariable(
...
#: logging a batch.
SKPLT_ASYNC_LOGGING_BUFFERING_SECONDS = _EnvironmentVariable(
...
#: (default: ``True``)
SKPLT_ENABLE_DB_SDK = _BooleanEnvironmentVariable("SKPLT_ENABLE_DB_SDK", True)

#: A flag that's set to 'true' in the child process for capturing modules.
_SKPLT_IN_CAPTURE_MODULE_PROCESS = _BooleanEnvironmentVariable(
    "SKPLT_IN_CAPTURE_MODULE_PROCESS", False
)
...
SKPLT_USE_DATABRICKS_SDK_MODEL_ARTIFACTS_REPO_FOR_UC = _BooleanEnvironmentVariable(
...
SKPLT_MODEL_ENV_DOWNLOADING_TEMP_DIR = _EnvironmentVariable(
...
SKPLT_RECORD_ENV_VARS_IN_MODEL_LOGGING = _BooleanEnvironmentVariable(
...
SKPLT_LOG_MODEL_COMPRESSION = _EnvironmentVariable(
...
SKPLT_CONVERT_MESSAGES_DICT_FOR_LANGCHAIN = _BooleanEnvironmentVariable(
...
_SKPLT_GO_STORE_TESTING = _BooleanEnvironmentVariable("SKPLT_GO_STORE_TESTING", False)
...
# serving environment.
_SKPLT_IS_IN_SERVING_ENVIRONMENT = _BooleanEnvironmentVariable(
...
#: Default: ``True``.
SKPLT_ENABLE_ASYNC_TRACE_LOGGING = _BooleanEnvironmentVariable(
    "SKPLT_ENABLE_ASYNC_TRACE_LOGGING", True
)

#: Maximum number of worker threads to use for async trace logging.
#: (default: ``10``)
SKPLT_ASYNC_TRACE_LOGGING_MAX_WORKERS = _EnvironmentVariable(
...
#: (default: ``1000``)
SKPLT_ASYNC_TRACE_LOGGING_MAX_QUEUE_SIZE = _EnvironmentVariable(
...
#: (default: ``500``)
SKPLT_ASYNC_TRACE_LOGGING_RETRY_TIMEOUT = _EnvironmentVariable(
...
#: (default: ``None``)
_SKPLT_ACTIVE_MODEL_ID = _EnvironmentVariable("_SKPLT_ACTIVE_MODEL_ID", str, None)
...
#: (default: ``100``)
_SKPLT_CREATE_LOGGED_MODEL_PARAMS_BATCH_SIZE = _EnvironmentVariable(
...
#: for a logged model.
#: (default: ``100``)
_SKPLT_LOG_LOGGED_MODEL_PARAMS_BATCH_SIZE = _EnvironmentVariable(
...
#: they are created.
#: (default: ``True``)
SKPLT_PRINT_MODEL_URLS_ON_CREATION = _BooleanEnvironmentVariable(
...
SKPLT_SEARCH_TRACES_MAX_THREADS = _EnvironmentVariable(
...
#: (default: ``None``).
SKPLT_LOGGING_LEVEL = _EnvironmentVariable("SKPLT_LOGGING_LEVEL", str, None)
