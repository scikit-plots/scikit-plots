...
from typing import Any, ClassVar, Dict, List  # noqa: F401
...
# https://www.sphinx-doc.org/en/master/usage/restructuredtext/directives.html#directive-danger
...
def setup(app: Sphinx) -> dict[str, Any]:  # noqa: D417
    """
