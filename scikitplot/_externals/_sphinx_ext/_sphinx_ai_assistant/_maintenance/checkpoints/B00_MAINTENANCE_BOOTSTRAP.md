...
Normalize the control plane and reconcile current source truth without changing production behavior.
...
- maintenance docs/schemas/trackers
...
- [ ] checker passes
- [ ] current baseline commands recorded truthfully
...
5. the next bounded checkpoint is `B01`.
