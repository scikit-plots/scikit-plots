# scikitplot/_externals/_sphinx_ext/_sphinx_url_helper/url_extension.py
#
...
def get_repl_url():
    """Set the REPL URL from the code in `initial_repl.py`."""
    ...
    # Return the repl_url
    return f"{base_url}?kernel={params['kernel']}&code={params['code']}"
