...
def _assign_where(X1, X2, cond):  # noqa: N803
    """
    ...
    if hasattr(X1, "mask"):  # pandas dataframes
        X1.mask(cond=cond, other=X2, inplace=True)  # noqa: PD002
    else:  # ndarrays
        X1[cond] = X2[cond]
...
class IterativeImputer(_BaseImputer):
    ...
    def _get_abs_corr_mat(self, X_filled, tolerance=1e-6):
        ...
        return abs_corr_mat  # noqa: RET504
    ...
    def _initial_imputation(self, X, in_fit=False):
        ...
        if not self.keep_empty_features:
            # drop empty features
            Xt = X[:, ~self._is_empty_feature]  # noqa: N806
    ...
    def fit_transform(self, X, y=None, **params):  # noqa: PLR0912
        """
        ...
        **params : dict
        ...
        n_samples, n_features = Xt.shape  # noqa: RUF059
        if self.verbose > 0:
            print(  # noqa: T201
                "[IterativeImputer] Completing matrix with shape %s"  # noqa: UP031
                % (X.shape,)
            )
        start_t = time()
        if not self.sample_posterior:
            Xt_previous = Xt.copy()  # noqa: N806
            normalized_tol = self.tol * np.max(np.abs(X[~mask_missing_values]))
        for self.n_iter_ in range(1, self.max_iter + 1):  # noqa: B020
            ...
            for feat_idx in ordered_idx:
                ...
                Xt, estimator = self._impute_one_feature(  # noqa: N806
                    Xt,
                    mask_missing_values,
                    feat_idx,
                    neighbor_feat_idx,
            ...
            if self.verbose > 1:
                print(  # noqa: T201
                    "[IterativeImputer] Ending imputation round "  # noqa: UP031
            ...
            if not self.sample_posterior:
                ...
                if self.verbose > 0:
                    print(  # noqa: T201
                        "[IterativeImputer] Change: {}, scaled tolerance: {} ".format(  # noqa: UP032
    ...
    def transform(self, X):
        ...
        for it, estimator_triplet in enumerate(self.imputation_sequence_):
            Xt, _ = self._impute_one_feature(  # noqa: N806
                Xt,
                mask_missing_values,
    ...
    def get_metadata_routing(self):
        ...
        return router  # noqa: RET504, W292
