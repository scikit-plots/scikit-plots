...
def display_colors(colors: List[str], title: str = "Color Display (Order)", show_indices: bool = False) -> None:
    """
...
def closest_color_name(hex_color: str, top_n: int = 1, use_lab: bool = False, tolerance: float = 0.0, 
                       use_spec: str = "CSS4", return_distances: bool = False) -> OrderedDict:
    """
