...
# https://github.com/astropy/astropy/blob/main/astropy/utils/
...
def deprecated(
    ...
    pending=False,
    obj_type=None,
    warning_type=ScikitplotDeprecationWarning,
    *,
    pending_warning_type=ScikitplotPendingDeprecationWarning,
):
    """
    ...
    warning_type : Warning
        ...
        Default is `~astropy.utils.exceptions.ScikitplotDeprecationWarning`.

    pending_warning_type : Warning
        Pending warning to be issued.
        This only works if ``pending`` is set to True.
        Default is `~astropy.utils.exceptions.ScikitplotPendingDeprecationWarning`.
    """
...
def deprecated_attribute(
    ...
    pending : bool, optional
        If True, uses a ScikitplotPendingDeprecationWarning instead of
        ``warning_type``.
    ...
    def decorate(raw_function):
        ...
        def decorated_function(*args, **kwargs):
            if len(args) > idx_min:
                ...
                warnings.warn(msg, ScikitplotDeprecationWarning, stacklevel=2)
