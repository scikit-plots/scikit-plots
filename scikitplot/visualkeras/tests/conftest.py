...
def pytest_generate_tests(metafunc):
    ...
    if "internal_model" in metafunc.fixturenames:
        metafunc.parametrize("internal_model", ["internal_functional_model_tf", "internal_sequential_model_tf"], indirect=True)
...
def _get_models(request):
    ...
    elif request.param in ["functional_model_keras_with_nested", "sequential_model_keras_with_nested"]:
