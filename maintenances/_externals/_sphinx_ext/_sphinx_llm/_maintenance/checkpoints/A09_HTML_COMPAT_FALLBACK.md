...
Move “any static HTML page” support into a lower-fidelity offline compatibility converter.
...
- post-build unmatched HTML scan
- sanitized conversion
- compatibility fidelity

## Non-goals

- runtime DOM as canonical source
...
- [ ] fallback pages labeled noncanonical
- [ ] scripts/raw markup safety fixtures
- [ ] coverage report distinguishes tiers
...
5. the next bounded checkpoint is `A10`.
