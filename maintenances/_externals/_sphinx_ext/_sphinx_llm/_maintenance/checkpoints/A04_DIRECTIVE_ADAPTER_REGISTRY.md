# A04 — Directive Adapter Registry
...
Implement/define semantic adapter registry and unknown-node policy.
...
- registry contract
- transparent container fallback
- semantic/media/raw policies
...
- [ ] unknown semantic leaf causes warning/error
- [ ] dropdown/tabs/video fixture expectations defined
...
5. the next bounded checkpoint is `A05`.
