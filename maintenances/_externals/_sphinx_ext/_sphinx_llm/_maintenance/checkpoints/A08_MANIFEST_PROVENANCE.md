...
Publish machine-readable document inventory, compatibility report, and artifact provenance.
...
- [ ] schemas validate
- [ ] every page artifact maps to source/docname
- [ ] unsupported count observable
...
5. the next bounded checkpoint is `A09`.
