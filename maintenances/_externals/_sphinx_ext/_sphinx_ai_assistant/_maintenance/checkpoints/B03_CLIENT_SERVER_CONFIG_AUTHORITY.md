# B03 — Client Server Config Authority
...
Eliminate secret-bearing client config as production authority and define schema-driven client-safe configuration.
...
- [ ] generated HTML secret-leak positive control
- [ ] discovery remains non-secret
...
5. the next bounded checkpoint is `B04`.
