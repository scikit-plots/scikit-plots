...
Run full multi-runtime verification, reconcile docs, and prove fresh-chat recoverability.
...
- all gates/state/history
- legacy research archival
- source-truth replay
...
- [ ] no unowned P0
- [ ] fresh chat derives exact next state
...
5. the next bounded checkpoint is `None`.
