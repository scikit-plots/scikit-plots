# B10 — Settings Schema Consolidation
...
Decide/promote a canonical settings registry with persistence/sensitivity/validation metadata.
...
- _ExtSettings prototype review
- 90 Sphinx config ownership
- client-safe schema
...
- [ ] single write path for migrated settings
- [ ] secret-class setting cannot serialize/persist
...
5. the next bounded checkpoint is `B11`.
