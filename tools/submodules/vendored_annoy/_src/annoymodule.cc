...
#define AVX_INFO "Using 256-bit AVX/AVX2 instructions"
...
py_an_init(py_annoy *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "i|s", (char**)kwlist, &f, &metric))
    // return (int) NULL; https://docs.python.org/3/extending/newtypes_tutorial.html
    // https://github.com/spotify/annoy/pull/675
    return -1;
  return 0;
}
