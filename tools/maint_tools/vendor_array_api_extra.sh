...
URL="https://github.com/data-apis/array-api-extra.git"  # xpx
VERSION="v0.7.1"

ROOT_DIR=$(realpath ../scikitplot/externals/array_api_extra)
...
echo "Update this directory using tools/maint_tools/vendor_array_api_extra.sh" >$ROOT_DIR/README.md
