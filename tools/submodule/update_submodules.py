...
def update_boost():
    ...
    run_command(
        "git config --global --add safe.directory /home/jovyan/work/contribution/scikit-plots/third_party/boost/libs/math"
    )
    ...
    run_command(
        'cd third_party/boost && git lfs track "third_party/boost/*"'
    )  # Track all files with LFS
