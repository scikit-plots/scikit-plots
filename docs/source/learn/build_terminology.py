...
ENRICH: dict[str, tuple[str, str]] = {
    ...
    "WMAPE (Weighted Mean Absolute Percentage Error)": ("evaluation", "MAP weighted by volume so large items count more."),
    ...
    "Mean Absolute Percentage Error (MAP)": ("evaluation", "The average absolute error expressed as a percentage of actuals."),
