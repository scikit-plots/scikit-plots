...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>Minimum Detectable Lift (MDL)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Minimum Detectable Lift (MDL) <https://insightful-data-lab.com/2025/08/24/minimum-detectable-lift-mdl/>`__ (insightful-data-lab.com).
