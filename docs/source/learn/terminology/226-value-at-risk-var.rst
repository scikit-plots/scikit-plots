...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📉&nbsp;&nbsp;<b>Value-at-Risk (VaR)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Value-at-Risk (VaR) <https://insightful-data-lab.com/2025/08/23/value-at-risk-var/>`__ (insightful-data-lab.com).
