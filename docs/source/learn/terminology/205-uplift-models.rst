...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔗&nbsp;&nbsp;<b>Uplift Models</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Uplift Models <https://insightful-data-lab.com/2025/08/23/uplift-models/>`__ (insightful-data-lab.com).
