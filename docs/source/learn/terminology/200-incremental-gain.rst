...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔗&nbsp;&nbsp;<b>Incremental Gain</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Incremental Gain <https://insightful-data-lab.com/2025/08/23/incremental-gain/>`__ (insightful-data-lab.com).
