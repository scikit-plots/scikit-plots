...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>ROC-AUC (Receiver Operating Characteristic – Area Under Curve, = AUROC)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `ROC-AUC (Receiver Operating Characteristic – Area Under Curve, = AUROC) <https://insightful-data-lab.com/2025/08/17/roc-auc-receiver-operating-characteristic-area-under-curve/>`__ (insightful-data-lab.com).
