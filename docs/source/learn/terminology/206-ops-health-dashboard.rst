...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>Ops Health Dashboard</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Ops Health Dashboard <https://insightful-data-lab.com/2025/08/23/ops-health-dashboard/>`__ (insightful-data-lab.com).
