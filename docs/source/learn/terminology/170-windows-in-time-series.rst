...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📈&nbsp;&nbsp;<b>Windows (in Time-Series)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Windows (in Time-Series) <https://insightful-data-lab.com/2025/08/23/windows-in-time-series-data-analysis/>`__ (insightful-data-lab.com).
