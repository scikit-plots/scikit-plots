...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📉&nbsp;&nbsp;<b>Predicting Percentiles</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Predicting Percentiles <https://insightful-data-lab.com/2025/08/22/predicting-percentiles/>`__ (insightful-data-lab.com).
