...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎲&nbsp;&nbsp;<b>Regression Coefficient</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Regression Coefficient <https://insightful-data-lab.com/2025/08/25/regression-coefficient/>`__ (insightful-data-lab.com).
