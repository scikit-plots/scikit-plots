...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>SLI (Service Level Indicator)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `SLI (Service Level Indicator) <https://insightful-data-lab.com/2025/08/23/sli-service-level-indicator/>`__ (insightful-data-lab.com).
