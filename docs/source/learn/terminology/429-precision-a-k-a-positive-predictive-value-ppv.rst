...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Precision (a.k.a. Positive Predictive Value, PPV)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Precision (a.k.a. Positive Predictive Value, PPV) <https://insightful-data-lab.com/2025/08/17/precision-a-k-a-positive-predictive-value-ppv/>`__ (insightful-data-lab.com).
