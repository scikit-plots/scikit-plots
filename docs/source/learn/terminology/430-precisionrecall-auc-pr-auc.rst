...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Precision–Recall AUC (PR-AUC)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Precision–Recall AUC (PR-AUC) <https://insightful-data-lab.com/2025/08/17/precision-recall-auc-pr-auc/>`__ (insightful-data-lab.com).
