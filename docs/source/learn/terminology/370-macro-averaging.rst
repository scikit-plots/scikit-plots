...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Macro Averaging</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Macro Averaging <https://insightful-data-lab.com/2025/08/20/macro-averaging/>`__ (insightful-data-lab.com).
