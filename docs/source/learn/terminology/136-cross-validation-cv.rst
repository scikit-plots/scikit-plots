...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧷&nbsp;&nbsp;<b>Cross-Validation (CV)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Cross-Validation (CV) <https://insightful-data-lab.com/2025/08/24/cross-validation-cv/>`__ (insightful-data-lab.com).
