...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧷&nbsp;&nbsp;<b>k-fold cross-validation</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `k-fold cross-validation <https://insightful-data-lab.com/2025/08/24/k-fold-cross-validation/>`__ (insightful-data-lab.com).
