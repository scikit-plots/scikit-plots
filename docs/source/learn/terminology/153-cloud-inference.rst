...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>Cloud Inference</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Cloud Inference <https://insightful-data-lab.com/2025/08/24/cloud-inference/>`__ (insightful-data-lab.com).
