...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Jensen–Shannon (JS) Divergence</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Jensen–Shannon (JS) Divergence <https://insightful-data-lab.com/2025/08/20/jensen-shannon-js-divergence/>`__ (insightful-data-lab.com).
