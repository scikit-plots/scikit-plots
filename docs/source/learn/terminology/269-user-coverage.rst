...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎁&nbsp;&nbsp;<b>User Coverage</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `User Coverage <https://insightful-data-lab.com/2025/08/22/user-coverage/>`__ (insightful-data-lab.com).
