...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔁&nbsp;&nbsp;<b>Bayesian Correction</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Bayesian Correction <https://insightful-data-lab.com/2025/08/23/bayesian-correction/>`__ (insightful-data-lab.com).
