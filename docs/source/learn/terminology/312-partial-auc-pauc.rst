...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Partial AUC (pAUC)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Partial AUC (pAUC) <https://insightful-data-lab.com/2025/08/21/partial-auc-pauc/>`__ (insightful-data-lab.com).
