...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📈&nbsp;&nbsp;<b>M-Competitions (Makridakis Competitions)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `M-Competitions (Makridakis Competitions) <https://insightful-data-lab.com/2025/08/22/m-competitions-makridakis-competitions/>`__ (insightful-data-lab.com).
