...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Drift Detection</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Drift Detection <https://insightful-data-lab.com/2025/08/24/drift-detection/>`__ (insightful-data-lab.com).
