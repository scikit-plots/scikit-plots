...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Covariate Drift (a.k.a. Covariate Shift)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Covariate Drift (a.k.a. Covariate Shift) <https://insightful-data-lab.com/2025/08/19/covariate-drift-a-k-a-covariate-shift/>`__ (insightful-data-lab.com).
