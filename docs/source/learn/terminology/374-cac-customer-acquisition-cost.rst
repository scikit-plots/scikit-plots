...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💼&nbsp;&nbsp;<b>CAC (Customer Acquisition Cost)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `CAC (Customer Acquisition Cost) <https://insightful-data-lab.com/2025/08/19/cac-customer-acquisition-cost/>`__ (insightful-data-lab.com).
