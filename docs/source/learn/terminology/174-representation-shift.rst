...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Representation Shift</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Representation Shift <https://insightful-data-lab.com/2025/08/23/representation-shift/>`__ (insightful-data-lab.com).
