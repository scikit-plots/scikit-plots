...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📈&nbsp;&nbsp;<b>Prophet — Time Series Forecasting by Facebook (Meta)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Prophet — Time Series Forecasting by Facebook (Meta) <https://insightful-data-lab.com/2025/08/23/prophet-time-series-forecasting-by-facebook-meta/>`__ (insightful-data-lab.com).
