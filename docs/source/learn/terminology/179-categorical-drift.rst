...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Categorical Drift</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Categorical Drift <https://insightful-data-lab.com/2025/08/23/categorical-drift/>`__ (insightful-data-lab.com).
