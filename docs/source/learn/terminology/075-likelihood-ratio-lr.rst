...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>Likelihood Ratio (LR)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Likelihood Ratio (LR) <https://insightful-data-lab.com/2025/08/25/likelihood-ratio-lr/>`__ (insightful-data-lab.com).
