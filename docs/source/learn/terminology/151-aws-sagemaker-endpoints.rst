...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>AWS SageMaker Endpoints</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `AWS SageMaker Endpoints <https://insightful-data-lab.com/2025/08/24/aws-sagemaker-endpoints/>`__ (insightful-data-lab.com).
