...
.. _term-ctr-click-through-rate:

:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💼&nbsp;&nbsp;<b>CTR (Click-Through Rate)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `CTR (Click-Through Rate) <https://insightful-data-lab.com/2025/08/17/ctr-click-through-rate/>`__ (insightful-data-lab.com).
