...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎁&nbsp;&nbsp;<b>Diversity (in Recommender Systems)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Diversity (in Recommender Systems) <https://insightful-data-lab.com/2025/08/19/diversity-in-recommender-systems/>`__ (insightful-data-lab.com).
