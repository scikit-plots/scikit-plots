...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔗&nbsp;&nbsp;<b>Uplift Random Forests</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Uplift Random Forests <https://insightful-data-lab.com/2025/08/21/uplift-random-forests/>`__ (insightful-data-lab.com).
