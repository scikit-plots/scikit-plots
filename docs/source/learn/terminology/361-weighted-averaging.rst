...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Weighted Averaging</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Weighted Averaging <https://insightful-data-lab.com/2025/08/20/weighted-averaging/>`__ (insightful-data-lab.com).
