...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🏋️&nbsp;&nbsp;<b>Deep Ensembles</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Deep Ensembles <https://insightful-data-lab.com/2025/08/20/deep-ensembles/>`__ (insightful-data-lab.com).
