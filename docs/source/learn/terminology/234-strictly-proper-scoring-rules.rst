...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📉&nbsp;&nbsp;<b>Strictly Proper Scoring Rules</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Strictly Proper Scoring Rules <https://insightful-data-lab.com/2025/08/22/strictly-proper-scoring-rules/>`__ (insightful-data-lab.com).
