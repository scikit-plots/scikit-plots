...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎲&nbsp;&nbsp;<b>Mean</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Mean <https://insightful-data-lab.com/2025/08/21/mean/>`__ (insightful-data-lab.com).
