...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>Baseline Heuristics</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Baseline Heuristics <https://insightful-data-lab.com/2025/08/17/baseline-heuristics/>`__ (insightful-data-lab.com).
