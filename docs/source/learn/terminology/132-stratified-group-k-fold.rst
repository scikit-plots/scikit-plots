...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧷&nbsp;&nbsp;<b>Stratified Group K-Fold</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Stratified Group K-Fold <https://insightful-data-lab.com/2025/08/24/stratified-group-k-fold/>`__ (insightful-data-lab.com).
