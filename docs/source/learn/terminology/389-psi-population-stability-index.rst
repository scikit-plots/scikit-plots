...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>PSI (Population Stability Index)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `PSI (Population Stability Index) <https://insightful-data-lab.com/2025/08/19/psi-population-stability-index/>`__ (insightful-data-lab.com).
