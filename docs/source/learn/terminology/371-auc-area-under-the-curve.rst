...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>AUC (Area Under the Curve)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `AUC (Area Under the Curve) <https://insightful-data-lab.com/2025/08/20/auc-area-under-the-curve/>`__ (insightful-data-lab.com).
