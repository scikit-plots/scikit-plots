...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Kullback–Leibler (KL) Divergence</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Kullback–Leibler (KL) Divergence <https://insightful-data-lab.com/2025/08/20/kullback-leibler-kl-divergence/>`__ (insightful-data-lab.com).
