...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>Mann–Whitney U Test (also called the Wilcoxon rank-sum test)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Mann–Whitney U Test (also called the Wilcoxon rank-sum test) <https://insightful-data-lab.com/2025/08/30/mann-whitney-u-test-also-called-the-wilcoxon-rank-sum-test/>`__ (insightful-data-lab.com).
