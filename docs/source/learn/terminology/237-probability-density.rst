...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎲&nbsp;&nbsp;<b>Probability Density</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Probability Density <https://insightful-data-lab.com/2025/08/22/probability-density/>`__ (insightful-data-lab.com).
