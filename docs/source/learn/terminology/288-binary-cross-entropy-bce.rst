...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🏋️&nbsp;&nbsp;<b>Binary Cross-Entropy (BCE)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Binary Cross-Entropy (BCE) <https://insightful-data-lab.com/2025/08/21/binary-cross-entropy-bce/>`__ (insightful-data-lab.com).
