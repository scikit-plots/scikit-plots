...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>R² (R-squared)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `R² (R-squared) <https://insightful-data-lab.com/2025/08/22/r%c2%b2-r-squared/>`__ (insightful-data-lab.com).
