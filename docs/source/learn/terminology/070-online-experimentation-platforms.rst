...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧫&nbsp;&nbsp;<b>Online Experimentation Platforms</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Online Experimentation Platforms <https://insightful-data-lab.com/2025/08/25/online-experimentation-platforms/>`__ (insightful-data-lab.com).
