...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎲&nbsp;&nbsp;<b>Cumulative Distribution Function (CDF)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Cumulative Distribution Function (CDF) <https://insightful-data-lab.com/2025/08/22/cumulative-distribution-function-cdf/>`__ (insightful-data-lab.com).
