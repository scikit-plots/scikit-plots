...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📈&nbsp;&nbsp;<b>Naïve Baseline Forecast</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Naïve Baseline Forecast <https://insightful-data-lab.com/2025/08/22/naive-baseline-forecast/>`__ (insightful-data-lab.com).
