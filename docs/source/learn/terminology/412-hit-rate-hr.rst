...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎁&nbsp;&nbsp;<b>Hit Rate (HR)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Hit Rate (HR) <https://insightful-data-lab.com/2025/08/19/hit-rate-hr/>`__ (insightful-data-lab.com).
