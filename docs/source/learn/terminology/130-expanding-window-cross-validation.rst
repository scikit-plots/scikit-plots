...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧷&nbsp;&nbsp;<b>Expanding Window Cross-Validation</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Expanding Window Cross-Validation <https://insightful-data-lab.com/2025/08/24/expanding-window-cross-validation/>`__ (insightful-data-lab.com).
