...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>Two-Proportion Z-Test</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Two-Proportion Z-Test <https://insightful-data-lab.com/2025/08/24/two-proportion-z-test/>`__ (insightful-data-lab.com).
