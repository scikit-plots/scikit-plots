...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💼&nbsp;&nbsp;<b>ROI (Return on Investment)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `ROI (Return on Investment) <https://insightful-data-lab.com/2025/08/23/roi-return-on-investment/>`__ (insightful-data-lab.com).
