...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>Significance Level (α)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Significance Level (α) <https://insightful-data-lab.com/2025/08/24/significance-level-%ce%b1/>`__ (insightful-data-lab.com).
