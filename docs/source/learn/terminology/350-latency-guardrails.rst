...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>Latency Guardrails</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Latency Guardrails <https://insightful-data-lab.com/2025/08/20/latency-guardrails/>`__ (insightful-data-lab.com).
