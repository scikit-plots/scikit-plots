...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔗&nbsp;&nbsp;<b>Causal Effect</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Causal Effect <https://insightful-data-lab.com/2025/08/21/causal-effect/>`__ (insightful-data-lab.com).
