...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>Model KPIs (Key Performance Indicators)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Model KPIs (Key Performance Indicators) <https://insightful-data-lab.com/2025/08/23/model-kpis-key-performance-indicators/>`__ (insightful-data-lab.com).
