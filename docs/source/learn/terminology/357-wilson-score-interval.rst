...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>Wilson Score Interval</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Wilson Score Interval <https://insightful-data-lab.com/2025/08/20/wilson-score-interval/>`__ (insightful-data-lab.com).
