...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎲&nbsp;&nbsp;<b>Probability Mass</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Probability Mass <https://insightful-data-lab.com/2025/08/22/probability-mass/>`__ (insightful-data-lab.com).
