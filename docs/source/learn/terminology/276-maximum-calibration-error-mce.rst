...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎯&nbsp;&nbsp;<b>Maximum Calibration Error (MCE)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Maximum Calibration Error (MCE) <https://insightful-data-lab.com/2025/08/22/maximum-calibration-error-mce/>`__ (insightful-data-lab.com).
