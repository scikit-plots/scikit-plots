...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎲&nbsp;&nbsp;<b>Sample Standard Deviation</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Sample Standard Deviation <https://insightful-data-lab.com/2025/08/25/sample-standard-deviation/>`__ (insightful-data-lab.com).
