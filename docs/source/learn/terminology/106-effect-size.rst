...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>Effect Size (δ)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Effect Size (δ) <https://insightful-data-lab.com/2025/08/24/effect-size-%ce%b4/>`__ (insightful-data-lab.com).
