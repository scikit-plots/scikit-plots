...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Multiclass Classification</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Multiclass Classification <https://insightful-data-lab.com/2025/08/21/multiclass-classification/>`__ (insightful-data-lab.com).
