...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Micro AUC</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Micro AUC <https://insightful-data-lab.com/2025/08/21/micro-auc/>`__ (insightful-data-lab.com).
