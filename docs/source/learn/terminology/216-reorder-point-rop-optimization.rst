...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📦&nbsp;&nbsp;<b>Reorder Point (ROP) Optimization</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Reorder Point (ROP) Optimization <https://insightful-data-lab.com/2025/08/23/reorder-point-rop-optimization/>`__ (insightful-data-lab.com).
