...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💼&nbsp;&nbsp;<b>Session Length</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Session Length <https://insightful-data-lab.com/2025/08/24/session-length/>`__ (insightful-data-lab.com).
