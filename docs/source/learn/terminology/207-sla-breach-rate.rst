...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>SLA Breach Rate</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `SLA Breach Rate <https://insightful-data-lab.com/2025/08/23/sla-breach-rate/>`__ (insightful-data-lab.com).
