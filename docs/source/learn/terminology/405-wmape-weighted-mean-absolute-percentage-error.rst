...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>WMAPE (Weighted Mean Absolute Percentage Error)</b></div>`

=================================================
WMAPE (Weighted Mean Absolute Percentage Error)
=================================================

*MAP weighted by volume so large items count more.*
...
.. seealso::
   ...
   Adapted in our own words from `WMAPE (Weighted Mean Absolute Percentage Error) <https://insightful-data-lab.com/2025/08/19/wmape-weighted-mean-absolute-percentage-error/>`__ (insightful-data-lab.com).
