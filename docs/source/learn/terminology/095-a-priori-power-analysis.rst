...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>A Priori Power Analysis</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `A Priori Power Analysis <https://insightful-data-lab.com/2025/08/24/a-priori-power-analysis/>`__ (insightful-data-lab.com).
