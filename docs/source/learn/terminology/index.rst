...
.. grid:: 1 2 2 2
   ...
   .. grid-item-card:: 🎲 Probability & Statistics Foundations
      :name: term-theme-probstats
      :class-card: sd-shadow-sm

      The vocabulary of estimates, spread and uncertainty that everything else builds on.

      :bdg-secondary:`28 terms`
      ^^^
   ...
   .. grid-item-card:: 🧮 Statistical Inference & Power
      :name: term-theme-inference
      :class-card: sd-shadow-sm

      Hypothesis testing, error rates and how big a study needs to be.

      :bdg-secondary:`23 terms`
      ^^^
   ...
   .. grid-item-card:: 💡 AI & ML Concepts
      :name: term-theme-concepts
      :class-card: sd-shadow-sm

      Umbrella terms for the field and its major model families.

      :bdg-secondary:`14 terms`
      ^^^
...
.. grid:: 1 2 2 2
   ...
   .. grid-item-card:: 🧪 Imbalanced Learning & Resampling
      :name: term-theme-imbalance
      :class-card: sd-shadow-sm

      Techniques for training useful models when one class is rare.

      :bdg-secondary:`9 terms`
      ^^^
   ...
   .. grid-item-card:: 📏 Classification & Averaging Metrics
      :name: term-theme-metrics
      :class-card: sd-shadow-sm

      Precision, recall, F1 and AUROC — and how they are averaged across classes.

      :bdg-secondary:`39 terms`
      ^^^
   ...
   .. grid-item-card:: 🔬 Model Evaluation & Uncertainty
      :name: term-theme-evaluation
      :class-card: sd-shadow-sm

      Putting error bars and significance around a model's score.

      :bdg-secondary:`21 terms`
      ^^^
   ...
   .. grid-item-card:: 🧫 A/B Testing & Experimentation
      :name: term-theme-abtest
      :class-card: sd-shadow-sm

      Designing and reading controlled online experiments.

      :bdg-secondary:`16 terms`
      ^^^
   ...
   .. grid-item-card:: 💼 Business & Growth Analytics
      :name: term-theme-growth
      :class-card: sd-shadow-sm

      The unit-economics and customer metrics that experiments optimise.

      :bdg-secondary:`36 terms`
      ^^^
   ...
   .. grid-item-card:: 🧷 Validation & Cross-Validation
      :name: term-theme-validation
      :class-card: sd-shadow-sm

      Splitting strategies that estimate performance honestly, including for time series.

      :bdg-secondary:`12 terms`
      ^^^
   ...
   .. grid-item-card:: 🏋️ Model Training & Optimization
      :name: term-theme-training
      :class-card: sd-shadow-sm

      Fitting, tuning and compressing models effectively.

      :bdg-secondary:`22 terms`
      ^^^
   ...
   .. grid-item-card:: 🧰 ML Platforms & Tools
      :name: term-theme-platforms
      :class-card: sd-shadow-sm

      Cloud services and APIs for building, serving and experimenting.

      :bdg-secondary:`7 terms`
      ^^^
   ...
   .. grid-item-card:: 📦 Operations & Supply Chain
      :name: term-theme-ops
      :class-card: sd-shadow-sm

      Inventory, demand and fulfillment metrics for operations.

      :bdg-secondary:`17 terms`
      ^^^
   ...
   .. grid-item-card:: 🧮 Data Preparation & Features
      :name: term-theme-features
      :class-card: sd-shadow-sm

      Transforming, encoding and organising raw data into model-ready form.

      :bdg-secondary:`4 terms`
      ^^^
...
.. grid:: 1 2 2 2
   ...
   .. grid-item-card:: ⚖️ Fairness & Calibration
      :name: term-theme-fairness
      :class-card: sd-shadow-sm

      Group-level fairness criteria and what each one equalises.

      :bdg-secondary:`8 terms`
      ^^^
   ...
   .. grid-item-card:: 🎰 Sequential Methods & Bandits
      :name: term-theme-bandits
      :class-card: sd-shadow-sm

      Adaptive decisions and tests that update as evidence arrives.

      :bdg-secondary:`6 terms`
      ^^^
   ...
   .. grid-item-card:: 📈 Signal Processing & Time Series
      :name: term-theme-signal
      :class-card: sd-shadow-sm

      Working with ordered, time-indexed and filtered data.

      :bdg-secondary:`19 terms`
      ^^^
   ...
   .. grid-item-card:: ⚙️ MLOps, Serving & Monitoring
      :name: term-theme-mlops
      :class-card: sd-shadow-sm

      Deploying, serving and keeping models healthy in production.

      :bdg-secondary:`24 terms`
      ^^^
   ...
   .. grid-item-card:: 🌊 Distribution Shift & Drift
      :name: term-theme-drift
      :class-card: sd-shadow-sm

      Detecting and measuring when data or representations change.

      :bdg-secondary:`20 terms`
      ^^^
   ...
   .. grid-item-card:: 🧬 Representations & Embeddings
      :name: term-theme-repr
      :class-card: sd-shadow-sm
   ...
   .. grid-item-card:: 🔎 Ranking & Interleaving
      :name: term-theme-ranking
      :class-card: sd-shadow-sm
   ...
   .. grid-item-card:: 🔗 Causal Inference & Uplift
      :name: term-theme-causal
      :class-card: sd-shadow-sm

      Estimating cause-and-effect and the incremental impact of actions.

      :bdg-secondary:`25 terms`
      ^^^
   ...
   .. grid-item-card:: 📉 Risk & Probabilistic Forecasting
      :name: term-theme-risk
      :class-card: sd-shadow-sm
   ...
   .. grid-item-card:: 🎁 Recommender Systems
      :name: term-theme-recsys
      :class-card: sd-shadow-sm
   ...
   .. grid-item-card:: 🎯 Probability Calibration
      :name: term-theme-calibration
      :class-card: sd-shadow-sm
   ...
   .. grid-item-card:: 🔍 Explainability & Governance
      :name: term-theme-xai
      :class-card: sd-shadow-sm
