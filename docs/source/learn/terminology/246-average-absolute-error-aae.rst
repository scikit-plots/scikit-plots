...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>Average Absolute Error (AAE)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Average Absolute Error (AAE) <https://insightful-data-lab.com/2025/08/22/average-absolute-error-aae/>`__ (insightful-data-lab.com).
