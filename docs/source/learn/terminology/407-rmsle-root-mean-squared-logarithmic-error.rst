...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>RMSLE (Root Mean Squared Logarithmic Error)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `RMSLE (Root Mean Squared Logarithmic Error) <https://insightful-data-lab.com/2025/08/19/rmsle-root-mean-squared-logarithmic-error/>`__ (insightful-data-lab.com).
