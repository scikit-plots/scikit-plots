...
:raw-html:`<div style="text-align: center"><strong>` Scikit-plots Contributing
...
.. docs/source/_sphinx_ext/skplt_ext/version_info_extension.py
...
.. https://matplotlib.org/sampledoc/sampledoc.pdf
.. seealso::
   * https://matplotlib.org/sampledoc/index.html
   * :download:`"Download matplotlib sampledoc.pdf" <./sampledoc.pdf>`.
...
.. Note:: Some Parts of this guides were adapted from the
    `matplotlib developer documentation <https://matplotlib.org/devdocs/devel/index.html>`__,
    `pandas developer documentation <https://pandas.pydata.org/pandas-docs/stable/development/index.html>`__,
    `astropy developer documentation <https://docs.astropy.org/en/latest/index_dev.html>`__,
    `scikit-learn developer documentation <https://scikit-learn.org/dev/developers/index.html>`__
   ...
   .. grid-item-card::
      ...
      **Docker Desktop or Github Codespaces**
      ...
      .. toctree::
         ...
         Python Env Manager Guide <guide_python_env_manager.rst>
...
:ref:`Getting Started Contribute Guide <contributing>`:
   ...
   .. grid-item-card::
      ...
      **Python Free-threaded (No-GIL) Guide**
      ...
      .. toctree::
         ...
         Python Free-threaded Guide <guide_python_nogil.rst>
