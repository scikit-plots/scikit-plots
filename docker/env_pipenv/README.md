...
| Import from `requirements.txt` to `Pipfile`                                                                                | `pipenv install -r ../../requirements/default.txt`                                |
| Import from `requirements.txt` to `Pipfile` (dev)                                                                          | `pipenv install --dev -r ../../requirements/all.txt`                              |
