...
def main():
    ...
    parser.add_argument('base_dir', nargs='?', default='galleries/examples', help='Base directory to search for scripts')
    parser.add_argument('--save-plots', action='store_true', help='Flag to save plots (default is to display them)')
