...
Establish canonical per-page Markdown from Sphinx semantics across supported builders.
...
- resolved doctree markdown
- html/dirhtml routing
- page discovery links

## Non-goals

- llms-full concatenation
- assistant migration
...
- [ ] directive fixture semantic parity
- [ ] routing matrix green
- [ ] provenance marks canonical fidelity
...
5. the next bounded checkpoint is `A06`.
