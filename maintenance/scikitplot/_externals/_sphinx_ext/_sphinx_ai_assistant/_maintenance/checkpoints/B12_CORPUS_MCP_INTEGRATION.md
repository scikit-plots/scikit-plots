...
Define protocol-neutral retrieval and MCP integration without duplicating their ownership.
...
- Corpus evidence contract consumption
- MCP wire integration boundary

## Non-goals

- new retrieval engine in assistant
...
- [ ] boundary tests
- [ ] no module-scope ownership inversion
...
5. the next bounded checkpoint is `B13`.
