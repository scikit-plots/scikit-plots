from numpy import abs, arange, asarray, atleast_2d, cos, exp, pi, sin, sum
...
class Thurber(Benchmark):
    ...
    def __init__(self, dimensions=7):
        ...
        self._bounds = list(
            zip(
                [500.0, 500.0, 100.0, 10.0, 0.1, 0.1, 0.0],
                [2000.0, 2000.0, 1000.0, 150.0, 2.0, 1.0, 0.2],
            )
        )
        self.global_optimum = [
            [
