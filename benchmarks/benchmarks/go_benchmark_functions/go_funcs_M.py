from numpy import abs, arange, asarray, cos, exp, log, pi, prod, sin, sqrt, sum, tan
...
class Meyer(Benchmark):
    ...
    def __init__(self, dimensions=3):
        ...
        self.global_optimum = [[5.6096364710e-3, 6.1813463463e3, 3.4522363462e2]]
